...
;(function () {
  ...
  function onThemeChange () {
    ...
    document.documentElement.classList.toggle('sand-theme', !this.checked)
    document.documentElement.setAttribute('data-theme', this.checked ? 'dark' : 'sand')
    saveTheme(this.checked ? 'dark' : 'sand')
    if (this.checked) {
